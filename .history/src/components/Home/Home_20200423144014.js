...
class Home extends Component {
  ...
  handleGuess = (level) => (e) => {
    ...
    if (
      hash ===
        "f17f05cf2c4c6979a552b48ce547b886d11df8295d0d7c72c7ecac1e66f71d84" &&
      level === 1
    ) {
      setTimeout(() => {
  ...
  TaskTab() {
    return (
      <>
        ...
        {this.state.level ===10 ? <a  rel="noopener noreferrer"
                    target="_blank" href="https://instagram.com/gec1.23?igshid=b46h2mkbt14v"}
