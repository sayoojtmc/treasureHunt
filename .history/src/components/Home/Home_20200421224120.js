...
class Home extends Component {
    ...
    if (level === 1) {
      return (
        <div className="col-sm-5 offset-sm-4 text-center">
          ...
          />
          {this.state.textWrong ? (
            <p className="text-red">Wrong answer!</p>
          ) : (
            ""
          )}
          <button
  ...
  render() {
    return (
      <div>
        {this.state.isWinner ? (
          <p>You have guessed right , your results will be notified!</p>
        ) : (
          <div
            style={{
              height: "50vh",
                    ...
                    <div className="form-group text-center">
                      ...
                      <div className="col-sm-5 offset-sm-3 text-center">
                        <input
                          ...
                          onChange={this.handleInput}
                        />
                      {this.state.guessEmpty?  <p className="text-red">Please type something</p>?""}
                      </div>
