...
class Home extends Component {
  ...
  win = (e) => {
    ...
    if (
      ...
      var decrement = this.props.firebase.firestore.FieldValue.increment(-1);
      this.setState({ guesses: this.state.guesses - 1 });
      this.props.firebase.firestore.doc(`users/${this.props.uid}`).update({
        guesses: firestore.FieldValue.increment(-1),
      });
              ...
              <form>
                {this.state.guesses > 0 ? (
                  <div className="form-group text-center">
                    ...
                    {this.state.guessEmpty ? <p>Please type something</p> : ""}
